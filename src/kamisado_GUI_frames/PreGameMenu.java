			...
			public void actionPerformed(ActionEvent e) {
				...
				if(human1TgBtn.isSelected() && computer2TgBtn.isSelected()) {
					...
					if (modesBox.getSelectedIndex() == 1) {
						GameFactory.createPlayerVsComputerSpeedLocalGame(name1, aiDifficulty2, limit, parent);
					} else {
						GameFactory.createPlayerVsComputerNormalLocalGame(name1, aiDifficulty2, limit, parent);
					}
				}
				...
				if(computer1TgBtn.isSelected() && human2TgBtn.isSelected()) {
					...
					if (modesBox.getSelectedIndex() == 1) {
						GameFactory.createComputerVsPlayerSpeedLocalGame(name2, aiDifficulty1, limit, parent);
					} else {
						GameFactory.createComputerVsPlayerNormalLocalGame(name2, aiDifficulty1, limit, parent);
					}
				}
				...
				if(computer1TgBtn.isSelected() && computer2TgBtn.isSelected()) {
					...
					if (modesBox.getSelectedIndex() == 1) {
						GameFactory.createComputerVsComputerSpeedLocalGame(aiDifficulty1, aiDifficulty2, limit, parent);
					} else {
						GameFactory.createComputerVsComputerNormalLocalGame(aiDifficulty1, aiDifficulty2, limit, parent);
					}
				}
